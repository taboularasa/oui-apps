...
import encounterContract from "./generated/ontobff/contract.json";
import outputManifest from "./generated/ontobff/manifest.json";

export const ouiRuntimeVersion = "1.0.0";

export interface EncounterContractIdentity extends OperationContractIdentity {
 ...
 */
export const encounterContractIdentity: EncounterContractIdentity = deepFreeze({
  applicationId: encounterContract.applicationId,
  irVersion: encounterContract.irVersion,
  irDigest: encounterContract.irDigest,
  bffPlanDigest: encounterContract.planDigest,
  descriptorDigest: encounterContract.descriptorDigest,
  ...
  requiredRuntimeRange: encounterContract.requiredRuntime,
 ...
 */
export function admitEncounterCompatibility(
  actual: BffCompatibility,
): EncounterContractIdentity {
  const expected = encounterContractIdentity;
